...
In my sophomore year at the University of St. Thomas, I had the opportunity to take CISC 420 - Computer Graphics. This class started with the basics, how is a line even drawn on a screen? How do we create a slope, and effectively display that? Throughout the semester, the topics progressed, exploring rendering and movements of objects, lighting, ray tracing, and so on! In this repository, it contains the four major assignments that were part of the class.
